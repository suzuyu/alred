...
配布ファイル名の例 (現状`alred-linux-x86_64`しか配布してません):
...
- `output/topology.md`: Mermaid 形式の構成図
- `output/topology_underlay.md`: underlay 表示付きの Mermaid 構成図
...
`topology.md` の Mermaid での描画例は下記の通りです。

![mermaid-lr](./images/mermaid-lr-001.png)

`topology_underlay.md` の Mermaid での描画例は下記の通りです。
